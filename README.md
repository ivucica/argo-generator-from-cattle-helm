...
Instead of using `quay.io/my-org/argocd-helmchart-generator:v1.0.0`, removed hostname for now and using `argo-generator-from-cattle-helm:v1.0.0`. Then moved to releases as `ghcr.io/ivucica/argo-generator-from-cattle-helm`.
